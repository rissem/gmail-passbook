Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  puts "GOOGLE KEY #{GOOGLE_KEY}"
  puts "GOOGLE SECRET #{GOOGLE_SECRET}"
  provider :google_oauth2, GOOGLE_KEY, GOOGLE_SECRET, {approval_prompt:"", scope: "https://mail.google.com", access_type: "online"}
end
